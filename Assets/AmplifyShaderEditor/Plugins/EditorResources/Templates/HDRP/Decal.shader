    ...
    SubShader
    {
		/*ase_subshader_options:Name=Additional Options
			Option:Affect BaseColor:false,true:true
				true:SetDefine:pragma shader_feature_local_fragment _MATERIAL_AFFECTS_ALBEDO
				false:RemoveDefine:pragma shader_feature_local_fragment _MATERIAL_AFFECTS_ALBEDO
				true:SetDefine:pragma shader_feature_local_fragment _COLORMAP
				false:RemoveDefine:pragma shader_feature_local_fragment _COLORMAP
			...
			Option:Affect Normal:false,true:true
				true:SetDefine:pragma shader_feature_local_fragment _MATERIAL_AFFECTS_NORMAL
				false:RemoveDefine:pragma shader_feature_local_fragment _MATERIAL_AFFECTS_NORMAL
                true:SetDefine:pragma shader_feature_local _NORMALMAP
                false:RemoveDefine:pragma shader_feature_local _NORMALMAP
			...
			Option:Affect Metal:false,true:true
				true:SetDefine:pragma shader_feature_local_fragment _MATERIAL_AFFECTS_MASKMAP
				false:RemoveDefine:pragma shader_feature_local_fragment _MATERIAL_AFFECTS_MASKMAP
				true:SetDefine:pragma shader_feature_local_fragment _MASKMAP
				false:RemoveDefine:pragma shader_feature_local_fragment _MASKMAP
			...
			Option:Affect Emission:false,true:true
				...
				true:SetDefine:pragma shader_feature_local_fragment _EMISSIVEMAP
				...
				false:RemoveDefine:pragma shader_feature_local_fragment _EMISSIVEMAP
        ...
        Pass
		{
           ...
           #define SCENEPICKINGPASS 1
						...
						)
			{
				...
				float3 baseColor = /*ase_frag_out:Base Color;Float3;0;-1;_Albedo*/float3( 0,0,0)/*end*/;
