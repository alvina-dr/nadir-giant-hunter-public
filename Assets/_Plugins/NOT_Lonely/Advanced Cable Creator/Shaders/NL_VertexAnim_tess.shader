...
Shader "NOT_Lonely/NL_VertexAnim_tess"
{
	Properties
	{
		...
		_MetallicGlossMap("Metallic (R) AO (G) Gloss (A)", 2D) = "black" {}
		...
		[ASEEnd]_ZeroHeightOffset("Zero Height Offset", Range( -0.2 , 0.2)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Color;
			float4 _BumpMap_ST;
			float _PrimaryAmplitude;
			float _PrimaryNoiseTiling;
			float _PrimarySpeed;
			float _SecondaryNoiseTiling;
			float _SecondarySpeed;
			float _SecondaryAmplitude;
			float _Height;
			float _ZeroHeightOffset;
			float _NormalScale;
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 uv_MetallicGlossMap = inputMesh.ase_texcoord.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float4 tex2DNode43 = tex2Dlod( _MetallicGlossMap, float4( uv_MetallicGlossMap, 0, 1.0) );
				float Height67 = ( tex2DNode43.b * _Height );
				float3 FinalHeight62 = ( inputMesh.normalOS * ( Height67 - _ZeroHeightOffset ) );
				...
				#endif
				float3 vertexValue = ( ( ( ( _PrimaryAmplitude * tex2Dlod( _Noise, float4( frac( ( ( ( _PrimaryNoiseTiling * appendResult21 * 0.01 ) + ( _TimeParameters.x * _PrimarySpeed ) ) + inputMesh.ase_color.r ) ), 0, 0.0) ) ) + ( tex2Dlod( _Noise, float4( frac( ( ( ( 0.01 * appendResult21 * _SecondaryNoiseTiling ) + ( _TimeParameters.x * _SecondarySpeed * -1.0 ) ) + inputMesh.ase_color.r ) ), 0, 0.0) ) * _SecondaryAmplitude ) ) * inputMesh.ase_color.a ) + float4( FinalHeight62 , 0.0 ) ).rgb;
						...
						)
			{
				...
				float3 unpack55 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _NormalScale );
				unpack55.z = lerp( 1, unpack55.z, saturate(_NormalScale) );
				...
				surfaceDescription.BaseColor = ( tex2DNode49 * _Color ).rgb;
				surfaceDescription.Normal = unpack55;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = tex2DNode43.r;
				...
				surfaceDescription.Smoothness = ( tex2DNode43.a * _GlossMapScale );
				surfaceDescription.Occlusion = saturate( ( tex2DNode43.g + ( 1.0 - _OcclusionStrength ) ) );
				surfaceDescription.Alpha = tex2DNode49.a;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				float2 appendResult21 = (float2(ase_worldPos.x , ase_worldPos.z));
				float2 uv_MetallicGlossMap = inputMesh.uv0.xy * _MetallicGlossMap_ST.xy + _MetallicGlossMap_ST.zw;
				float4 tex2DNode43 = tex2Dlod( _MetallicGlossMap, float4( uv_MetallicGlossMap, 0, 1.0) );
				float Height67 = ( tex2DNode43.b * _Height );
				float3 FinalHeight62 = ( inputMesh.normalOS * ( Height67 - _ZeroHeightOffset ) );
...
Node;AmplifyShaderEditor.WorldPosInputsNode;15;-4209.177,54.96732;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;16;-3532.365,1004.531;Inherit;False;Constant;_Float1;Float 1;5;0;Create;True;0;0;0;False;0;False;-1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-3557.304,899.9781;Float;False;Property;_SecondarySpeed;Secondary Speed;11;0;Create;True;0;0;0;False;0;False;0.5;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-3484.978,114.8224;Inherit;False;Constant;_Float2;Float 2;7;0;Create;True;0;0;0;False;0;False;0.01;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-3539.987,369.2036;Inherit;False;Property;_SecondaryNoiseTiling;Secondary Noise Tiling;9;0;Create;True;0;0;0;False;0;False;8;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;20;-3577.969,610.0897;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;21;-3925.523,98.88588;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-3571.687,712.3553;Float;False;Property;_PrimarySpeed;Primary Speed;10;0;Create;True;0;0;0;False;0;False;0.5;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-3535.45,-76.62701;Inherit;False;Property;_PrimaryNoiseTiling;Primary Noise Tiling;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;24;-3317.17,633.6185;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-3325.837,854.806;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;26;-3291.025,240.5849;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-3288.18,-33.27885;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;28;-3071.411,642.4329;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;29;-3096.451,161.4822;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.VertexColorNode;30;-3202.976,1073.189;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;31;-2906.276,586.3397;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleAddOpNode;32;-2946.518,201.9125;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FractNode;33;-2776.766,601.2519;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;34;-3031.079,-331.3826;Inherit;True;Property;_Noise;Noise;7;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FractNode;35;-2817.008,216.8247;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;36;-2607.253,-7.261795;Inherit;True;Property;_Noise_A;Noise_A;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;37;-2464.114,-377.7421;Inherit;False;Property;_PrimaryAmplitude;Primary Amplitude;12;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;38;-2586.774,616.048;Inherit;False;Property;_SecondaryAmplitude;Secondary Amplitude;13;0;Create;True;0;0;0;False;0;False;0;0.02;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;39;-2618.403,323.5518;Inherit;True;Property;_Noise_B;Noise_B;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;40;-891.9604,272.2879;Inherit;False;Property;_OcclusionStrength;Occlusion Strength;4;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;41;-599.0518,276.3335;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;-2186.025,351.1066;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;43;-1619.648,-8.797836;Inherit;True;Property;_MetallicGlossMap;Metallic (R) AO (G) Gloss (A);2;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-2172.145,85.21498;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;45;-409.8167,215.1512;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-892.5949,173.243;Inherit;False;Property;_GlossMapScale;Smoothness;3;0;Create;False;0;0;0;False;0;False;1;0.696;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;47;-1841.372,295.3384;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;48;-1859.77,-139.4972;Inherit;False;Property;_NormalScale;Normal Scale;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;49;-1947.27,-626.9502;Inherit;True;Property;_MainTex;Base Color;1;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;50;-1881.886,-404.3123;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.509434,0.509434,0.509434,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;51;-1277.156,439.8055;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;52;-413.6688,105.6878;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;53;-1516.27,-625.9502;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;54;-264.8167,218.1512;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;55;-1623.61,-218.4009;Inherit;True;Property;_BumpMap;Normal;5;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;56;-1578.9,1077.572;Inherit;False;939.3854;404.3158;Comment;6;62;57;58;59;61;60;Displacement;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleAddOpNode;63;-726.3522,567.1008;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;64;-966.3527,663.1006;Inherit;False;62;FinalHeight;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;60;-1236.182,1290.043;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;61;-1057.777,1217.168;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NormalVertexDataNode;59;-1277.151,1125.206;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;58;-1427.472,1284.421;Inherit;False;67;Height;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;57;-1546.703,1386.381;Inherit;False;Property;_ZeroHeightOffset;Zero Height Offset;15;0;Create;True;0;0;0;False;0;False;0;0;-0.2;0.2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;62;-877.0991,1214.783;Inherit;False;FinalHeight;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;66;-1286.63,207.6246;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;67;-1143.087,200.3848;Inherit;False;Height;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;65;-1582.485,227.2417;Inherit;False;Property;_Height;Height;14;0;Create;True;0;0;0;False;0;False;0.5;0.063;0;0.5;0;1;FLOAT;0
WireConnection;0;0;53;0
WireConnection;0;1;55;0
WireConnection;0;4;43;1
...
ASEEND*/
//CHKSM=23FFFAEDD074EC9BD84E6A78C9827C9BDE1142C4