...
Shader "New Amplify Shader"
{
	Properties
	{
		...
		_tex_basecolor("tex_basecolor", 2D) = "white" {}
		_tex_normal("tex_normal", 2D) = "white" {}
		[Normal]_tex_height("tex_height", 2D) = "white" {}
		_fallof3("fallof", Float) = 0
		_displacement_intensity("displacement_intensity", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _tex_height;
			sampler2D _tex_basecolor;
			...
			inline float3 TriplanarSampling48( sampler2D topTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
				float3 projNormal = ( pow( abs( worldNormal ), falloff ) );
				projNormal /= ( projNormal.x + projNormal.y + projNormal.z ) + 0.00001;
				float3 nsign = sign( worldNormal );
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 triplanar68 = TriplanarSampling68( _tex_height, ase_worldPos, ase_worldNormal, _fallof3, temp_cast_0, 1.0, 0 );
				...
				float3 tangentToWorldPos66 = mul( ase_tangentToWorldFast, triplanar68.xyz );
				...
				#endif
				float3 vertexValue = ( ( _displacement_intensity * tangentToWorldPos66 ) * inputMesh.positionOS );
						...
						)
			{
				...
				float4 triplanar34 = TriplanarSampling34( _tex_basecolor, ase_worldPos, normalWS, _fallof3, temp_cast_0, 1.0, 0 );
				...
				float3 triplanar48 = TriplanarSampling48( _tex_normal, ase_worldPos, normalWS, _fallof3, temp_cast_2, 1.0, 0 );
				float3 tanTriplanarNormal48 = mul( ase_worldToTangent, triplanar48 );
				
				surfaceDescription.BaseColor = triplanar34.xyz;
				surfaceDescription.Normal = tanTriplanarNormal48;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 triplanar34 = TriplanarSampling34( _tex_basecolor, ase_worldPos, ase_worldNormal, _fallof3, temp_cast_0, 1.0, 0 );
				
				float2 temp_cast_2 = (_Tiling1).xx;
				float3 ase_worldTangent = packedInput.ase_texcoord4.xyz;
				float3 ase_worldBitangent = packedInput.ase_texcoord5.xyz;
				float3x3 ase_worldToTangent = float3x3(ase_worldTangent,ase_worldBitangent,ase_worldNormal);
				float3 triplanar48 = TriplanarSampling48( _tex_normal, ase_worldPos, ase_worldNormal, _fallof3, temp_cast_2, 1.0, 0 );
				float3 tanTriplanarNormal48 = mul( ase_worldToTangent, triplanar48 );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float3x3 ase_worldToTangent = float3x3(tangentWS.xyz,ase_worldBitangent,normalWS);
				float3 triplanar48 = TriplanarSampling48( _tex_normal, ase_worldPos, normalWS, _fallof3, temp_cast_0, 1.0, 0 );
				float3 tanTriplanarNormal48 = mul( ase_worldToTangent, triplanar48 );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.TexturePropertyNode;62;-2032,304;Inherit;True;Property;_tex_height;tex_height;4;1;[Normal];Create;True;0;0;0;False;0;False;e74d746a9cce461438c2008aacaa1d82;4c583d55d52be66478162e42d8add54d;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;51;-1792,48;Inherit;False;Property;_Tiling1;Tiling;1;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;63;-1952,496;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;88;-1792,-544;Inherit;False;Property;_fallof3;fallof;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;68;-1728,304;Inherit;True;Spherical;World;False;Top Texture 2;_TopTexture2;white;-1;None;Mid Texture 2;_MidTexture2;white;-1;None;Bot Texture 2;_BotTexture2;white;-1;None;Triplanar Sampler;World;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TransformPositionNode;66;-1360,288;Inherit;True;Tangent;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;93;-1376,192;Inherit;False;Property;_displacement_intensity;displacement_intensity;6;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;95;-1120,256;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PosVertexDataNode;96;-1344,528;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldPosInputsNode;39;-1872,-752;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TexturePropertyNode;31;-1984,-944;Inherit;True;Property;_tex_basecolor;tex_basecolor;2;0;Create;True;0;0;0;False;0;False;4c583d55d52be66478162e42d8add54d;4c583d55d52be66478162e42d8add54d;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TriplanarNode;34;-1632,-784;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;-1;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;46;-2560,-608;Inherit;False;Property;_Tiling;Tiling;0;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;83;-1952,-560;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.WorldPosInputsNode;49;-1824,-96;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TriplanarNode;48;-1552,-160;Inherit;True;Spherical;World;True;Top Texture 1;_TopTexture1;white;-1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;47;-1936,-304;Inherit;True;Property;_tex_normal;tex_normal;3;0;Create;True;0;0;0;False;0;False;3414d76984eceb246b72da10afbac3a8;4c583d55d52be66478162e42d8add54d;True;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;91;-544,-624;Inherit;False;Constant;_Float0;Float 0;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;69;-960,256;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;3;-352,-784;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;12;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;34;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefGBuffer;255;False;;255;True;_StencilWriteMaskGBuffer;7;False;;3;False;;0;False;;0;False;;7;False;;3;False;;0;False;;0;False;;False;False;True;0;True;_ZTestGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;38;Surface Type;0;0;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;1;638495603755739311;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;0;0;  Energy Conserving Specular;1;0;  Transmission,InvertActionOnDeselection;0;0;Receive Decals;1;0;Receive SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;0;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;  Conserative;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;1;638495605643488241;  Phong;0;0;  Strength;0.5,False,;0;  Type;1;638495602670244645;  Tess;14,False,;638495599889875623;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;638495606215613744;0;11;True;True;True;True;True;False;False;False;False;True;True;False;;False;0
WireConnection;68;0;62;0
WireConnection;68;9;63;0
WireConnection;68;3;51;0
WireConnection;68;4;88;0
WireConnection;66;0;68;0
WireConnection;95;0;93;0
WireConnection;95;1;66;0
WireConnection;34;0;31;0
WireConnection;34;9;39;0
WireConnection;34;3;51;0
WireConnection;34;4;88;0
WireConnection;83;0;46;0
WireConnection;83;1;46;0
WireConnection;83;2;46;0
WireConnection;48;0;47;0
WireConnection;48;9;49;0
WireConnection;48;3;51;0
WireConnection;48;4;88;0
WireConnection;69;0;95;0
WireConnection;69;1;96;0
WireConnection;3;0;34;0
WireConnection;3;1;48;0
WireConnection;3;7;91;0
WireConnection;3;11;69;0
ASEEND*/
//CHKSM=D80A847076B1A439E3A764E04AD2DF3872357510